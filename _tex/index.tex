...
\hypersetup{
  ...
  pdfauthor={Alice Beckmann; Bob Johnson; Carol Lee},
...
\textsubscript{Source:
\href{https://afuenteshinojosa.github.io/test-paper/index.qmd.html}{Article
Notebook}}
...
\subsection{Cata is teaching us how to use
Quarto}\label{cata-is-teaching-us-how-to-use-quarto}

\section{Now I want to see some
differences}\label{now-i-want-to-see-some-differences}

\section{There are more updates}\label{there-are-more-updates}

\subsection{Can you see the changes??}\label{can-you-see-the-changes}

Now it should work the quarto render. So, does the error disappeared?
